...
Ask the user to choose between "searches for treasure" or "battle enemy ships".
...
action=input("Choose if you want to 'searches for treasure' or 'battle enemy ships':").lower()
if action=='searches for treasure':
...
elif action=='battle enemy ships':
