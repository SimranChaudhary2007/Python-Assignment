...
subject=input("Do you want to 'spells' or 'potions'?:").lower()
if subject=='spells':
    choice=input("Do you want to 'practice magic' or 'complete in duels'?:").lower()
    if choice=='practice magic':
        print("You mastered a powerful spell. You Win!")
    elif choice=='complete in duels':
